...
public final class Affichage extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		if(lesPlanetes != null || lesVaisseaux != null){
			...
			for (Vaisseaux v : lesVaisseaux) {
				afficheVaisseau(g,v.getAbscisse(),v.getOrdonnee(),v.getResistance(),v.getTypeDeplacement()+v.equipementCourant(),v.getColorEntite());
			}
		}
	}
