...
public class Simulation {
	 ...
	 *  la partie se termine s'il n'y a que des entités de 
	 *  meme couleur dans la galaxie
	 */
	public static Boolean victoire() {
		...
		if(victoire){
			...
			//couleur blanche pour aucun vainquer
	...
	public static void main(String[] args) {
		...
		while (!victoire() && tour<Constantes.TourMax) {
			...
			for (Espece e : especes) {
				...
				e.getEmpire().constructionVaisseaux(e.getTauxProductivite(),galaxie); // construction des vaisseaux
				e.getEmpire().deplacementVaisseaux(especes,galaxie); // deplacement des vaisseaux
				e.getEmpire().interaction(especes ,e.getEmpire(),pI,galaxie); //interaction des entités
			}
		...
		afficheVainqueur(); // Affichage du vainquer.
