...
public class Fabrique {
	...
	public Piece rotationPiece(Piece p){
		...
		if(p.getCelluleUn().getC() == 'a'){
			...
			switch (pos) {
			case 1:pr = new Piece(new Cellule(cx,cy,'a'),new Cellule(cx+1,cy,'a'),new Cellule(cx+1,cy,'a'),new Cellule(cx,cy,'a'));break;//carre
			case 2:pr = new Piece(new Cellule(cx,cy,'a'),new Cellule(cx+1,cy,'a'),new Cellule(cx+1,cy,'a'),new Cellule(cx,cy,'a'));break;//carre
			case 3:pr = new Piece(new Cellule(cx,cy,'a'),new Cellule(cx+1,cy,'a'),new Cellule(cx+1,cy,'a'),new Cellule(cx,cy,'a'));break;//carre
			case 4:pr = new Piece(new Cellule(cx,cy,'a'),new Cellule(cx+1,cy,'a'),new Cellule(cx+1,cy,'a'),new Cellule(cx,cy,'a'));pos=-1;break;//carre
			}
		}
			...
			cy = p.getCelluleUn().getY();
			switch (pos) {
			case 1:pr = new Piece(new Cellule(cx,cy,'b'),new Cellule(cx,cy+1,'b'),new Cellule(cx,cy+2,'b'),new Cellule(cx,cy+3,'b'));break;//baton
			case 2:pr = new Piece(new Cellule(cx,cy,'b'),new Cellule(cx+1,cy,'b'),new Cellule(cx+2,cy,'b'),new Cellule(cx+3,cy,'b'));break;//baton
			case 3:pr = new Piece(new Cellule(cx,cy,'b'),new Cellule(cx,cy+1,'b'),new Cellule(cx,cy+2,'b'),new Cellule(cx,cy+3,'b'));break;//baton
			case 4:pr = new Piece(new Cellule(cx,cy,'b'),new Cellule(cx+1,cy,'b'),new Cellule(cx+2,cy,'b'),new Cellule(cx+3,cy,'b'));break;//baton
			}
		}
		return pr;
	}
