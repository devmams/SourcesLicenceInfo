...
public class Constantes {
	...
	// Caractéristiques de l'espece
	public static final int TauxNataliteMin = 5;
	public static final int TauxNataliteMax = 10;
	public static final int TauxProductiviteMin = 1;
	public static final int TauxProductiviteMax = 5;
	
	
	// Caractéristique de l'empire
	public static final int NombrePlaneteIni = 1;
	public static final int NombreVaisseauxIni = 2;
	...
	public static final int TourMs = 5; // durée d'un tour en millisecondes
