...
public class Segment extends Droite {
	...
	/**
	 * Affiche le résultat de l'intersection entre deux segments
	 * @param Quatre points 
	 */
	...
	/**
	 * Fonction vérifiant si un point est sommet d'un segment
	 * @param le point p
	 * @return "true" si le point est sommet et "false" sinon 
	 */
	...
	/**
	 * Fonction vérifiant si un point appartient à un segment
	 * @param l'autre segment
	 * @return "true" s'il appartient et "false" sinon 
	 */
	...
	/**
	 * Fonction retournant le maximum entre deux nombres
	 * @param les deux réels à comparer
