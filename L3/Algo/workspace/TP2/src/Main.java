...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("intersecteSeg : "+d1.intersectionSegments(A, B, C, D));

		if(d1.intersectionSegments(A, B, C, D))
		...
		Polygone plg = new Polygone(A,B,C);
		plg.posPointTriangle(new Point(1,0));
	}
}
